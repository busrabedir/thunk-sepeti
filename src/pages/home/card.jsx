...
const Card = ({ item }) => {
  return (
    <Link
      ...
      className="box block relative overflow-hidden cursor-pointer transition duration-300 hover:-translate-y-1"
    >
      ...
      <img
        src={item.photo}
        alt={item.name}
        className="w-full object-cover h-[230px] lg:h-[200px] rounded-3xl"
      />
